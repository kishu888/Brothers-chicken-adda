import { A as prettyDate, D as inr, E as businessToday, O as kg, _ as useReverseSale, f as useChickenTypes, h as usePeriod, j as prettyTime, o as useAddSale, v as useSalesForDate } from "./data-BXdCoojx.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { r as Stat, t as DateBar } from "./Stat-C4Ts9jut.js";
import { n as buttonVariants, t as Button } from "./button-BkEeRci-.js";
import { t as Input } from "./input-B8Q2ztVi.js";
import { r as summarize } from "./finance-3gIK0WeS.js";
import * as React from "react";
import { useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { ArrowLeft, Banknote, Bird, Check, Delete, Plus, Smartphone, Undo2, Wheat } from "lucide-react";
import * as AlertDialogPrimitive from "@radix-ui/react-alert-dialog";
//#region src/components/NumberPad.tsx
var KEYS = [
	"7",
	"8",
	"9",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [onBack ? /* @__PURE__ */ jsx(Button, {
					variant: "ghost",
					size: "icon",
					onClick: onBack,
					"aria-label": "Back",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: KEYS.map((k) => /* @__PURE__ */ jsx("button", {
					type: "button",
					onClick: () => press(k),
					className: cn("keypad-key"),
					"aria-label": k === "back" ? "Backspace" : k,
					children: k === "back" ? /* @__PURE__ */ jsx(Delete, { className: "size-6" }) : k
				}, k))
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Button, {
					...
					children: [
						/* @__PURE__ */ jsx(Check, { className: "size-5" }),
						" ",
						confirmLabel
					]
				})]
...
function SalesPage() {
	...
	if (step === "chickenType") return /* @__PURE__ */ jsxs("div", {
		...
		}), chickenTypes.isLoading ? /* @__PURE__ */ jsx("div", {
			className: "rounded-2xl border bg-card p-10 text-center",
			children: "Loading chicken types..."
		}) : activeChickenTypes.length === 0 ? /* @__PURE__ */ jsxs("div", {
			className: "rounded-2xl border bg-card p-10 text-center",
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", {
								...
								children: isBroiler ? /* @__PURE__ */ jsx(Bird, { className: "size-10" }) : /* @__PURE__ */ jsx(Wheat, { className: "size-10" })
							})
						}),
						/* @__PURE__ */ jsx("div", {
	...
	if (step === "weight") return /* @__PURE__ */ jsxs("div", {
		className: "mx-auto w-full max-w-2xl",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			hint: /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsx("span", { children: prettyDate(date) }),
				/* @__PURE__ */ jsx("span", {
					className: "mx-1",
					children: "·"
				}),
				/* @__PURE__ */ jsx("span", { children: selectedChickenType?.name })
			] })
		})]
	});
	if (step === "amount") return /* @__PURE__ */ jsxs("div", {
		className: "mx-auto w-full max-w-2xl",
		children: [/* @__PURE__ */ jsxs("div", {
			className: "mb-4 rounded-xl border bg-card px-4 py-3",
			children: [
			...
			hint: /* @__PURE__ */ jsxs(Fragment, { children: [kg(w), a > 0 ? ` · ${inr(a / w, true)}/kg` : ""] }),
			children: /* @__PURE__ */ jsxs("div", {
				className: "mt-4",
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: ["cash", "online"].map((m) => /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => setMethod(m),
						...
						children: [m === "cash" ? /* @__PURE__ */ jsx(Banknote, { className: "size-5" }) : /* @__PURE__ */ jsx(Smartphone, { className: "size-5" }), m]
					}, m))
				})]
			})
		})]
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
			...
			}) : rows.map((r, i) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					r.status === "active" ? /* @__PURE__ */ jsx("button", {
						onClick: () => {
							setReverseId(r.id);
							setReason("");
						},
						...
						children: /* @__PURE__ */ jsx(Undo2, { className: "size-4" })
					}) : /* @__PURE__ */ jsx("span", {})
				]
			}, r.id))]
		}),
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: /* @__PURE__ */ jsx(Undo2, { className: "size-5" })
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs(Button, {
				...
				onClick: startSale,
				children: [/* @__PURE__ */ jsx(Plus, { className: "size-6" }), "ADD SALE"]
			})
		}),
		/* @__PURE__ */ jsx(AlertDialog, {
			...
			children: /* @__PURE__ */ jsxs(AlertDialogContent, { children: [
				/* @__PURE__ */ jsxs(AlertDialogHeader, { children: [/* @__PURE__ */ jsx(AlertDialogTitle, { children: "Reverse this sale?" }), /* @__PURE__ */ jsx(AlertDialogDescription, { children: "The record is never deleted. It is marked reversed and kept in the audit history with your reason." })] }),
				/* @__PURE__ */ jsx(Input, {
